...
def getBBForLabel(baseDatasetPath, layoutPath):
    ...
    #print("front BB : ",frontRackBBox, frontBoxesBBox)
    front = img
...
freeSpace = []
freeSpaceAboveBox = []
for_boxes = [507, 5, 7744, 858, 6413, 3272, 7265, 7366]
#507
#5
#7744
#858
...
for i in range(3):
    ...
    #frontFreeSpaceBBoxs, freeFrontSpaceAboveBoxs = getBBForLabel('../../../trained23feb/anurag_images/forDiversity_1/6413/', str(i)+".png")
    topRackBBox, topBoxesBBox, frontRackBBox, frontBoxesBBox,topFreeSpaceBBoxs, \
    frontFreeSpaceBBoxs, freeFrontSpaceAboveBoxs = getBBForLabel('../../../trained23feb/front_top/test_images_discr/', '006413rackno_'+str(i)+".png")
    #print("(topFreeSpaceBBoxs, frontFreeSpaceBBoxs)",topFreeSpaceBBoxs, frontFreeSpaceBBoxs)
    ...
    boxes.append(Boxes)
    #print("freeSpaces3D : ",freeSpaces3D)
...
#print(freeSpaceVolume*(0.015625**1) - occupiedByBoxes*(0.015625**1))
