...
path = "../datasets/for_multiple_racks/layouts/labels/"
layout_dump_path = "../datasets/for_multiple_racks/layouts/warehouse/"
layout_Images_dump_path = "../datasets/for_multiple_racks/layouts/debug_visualizations/"
