    ...
    def generate_layout_from_file(self, files, dump_path, aa, bb, cc, dd, ee, ff):
        for file in files:
            ...
            for annotationLine in annotationLines:
                ...
                # object_dimensions[0] *= 2
                # object_dimensions[1] *= 2
            ...
            generateShelfCentricTopLayout.writeLayout(ID, dump_path, shelfs_and_boxes, min_shelf_number, max_shelf_number)
            generateShelfCentricFrontLayout.writeLayout(ID, dump_path, shelfs_and_boxes, min_shelf_number, max_shelf_number)
            # return
