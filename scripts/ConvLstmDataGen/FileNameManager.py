...
class FilePathManager(object):
    def __init__(self):
        ...
        self.datasetDumpDirectory = "/home/anurag/Research/Unity/data/"
        ...
        self.anurag3DKeyPointsPath = self.anuragAnnotationsPath + "ThreeDPoints/"
    ...
    def ensureDatasetDirectory(self):
        ...
        try:
            ...
            pass
        try:
            os.makedirs(self.anurag3DKeyPointsPath)
        except FileExistsError:
            pass
